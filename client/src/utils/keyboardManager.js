...
export const KEYBOARD_ACTIONS = {
  ...
  TOGGLE_AUTO_EXPLORE: "TOGGLE_AUTO_EXPLORE",
  TOGGLE_BOOKMARKS: "TOGGLE_BOOKMARKS",
  TOGGLE_SCALE_COMPARISON: "TOGGLE_SCALE_COMPARISON",
};
...
export const KEYBOARD_SHORTCUTS = {
  ...
  [KEYBOARD_ACTIONS.TOGGLE_AUTO_EXPLORE]: ["a"],
  [KEYBOARD_ACTIONS.TOGGLE_BOOKMARKS]: ["k"],
  [KEYBOARD_ACTIONS.TOGGLE_SCALE_COMPARISON]: ["x"],
};
